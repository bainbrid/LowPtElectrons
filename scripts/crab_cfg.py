...
data_sets = {
    ...
    "miniaod":{
        ...
        'nonres_med':'/BuToKJpsi_Toee_Mufilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen/RunIIAutumn18MiniAOD-PUPoissonAve20_BParking_102X_upgrade2018_realistic_v15_ext1-v2/MINIAODSIM', #  696.6GB, 10193124 events, 253 files (on multiple sites)
...
data_set = {'aod':    data_sets.get(data_tier,'')['res_small'],
            'miniaod':data_sets.get(data_tier,'')['res_small'],
